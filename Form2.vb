Public Class Form2
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim barang(9) As String
        barang(0) = "Ayam bakar - Cabe ijo"
        barang(1) = "Ayam bakar - Cabe merah"
        barang(2) = "Ayam goreng - kriuk"
        barang(3) = "Ayam goreng - tepung"
        barang(4) = "Ayam pedas manis"
        barang(5) = "Bebek bakar"
        barang(6) = "Bebek goreng"
        barang(7) = "Rendang"
        barang(8) = "Telor dadar"
        barang(9) = "Telor ceplok"
